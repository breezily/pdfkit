...
namespace PDFToolz
{
    ...
    public class PDFFactory
    {
        ...
        public void AddDocument(string filename,string password)
        {
            documents.Add(new PdfSegment(new PdfReader(filename, ASCIIEncoding.Default.GetBytes(password)), 1, -1));
        }
